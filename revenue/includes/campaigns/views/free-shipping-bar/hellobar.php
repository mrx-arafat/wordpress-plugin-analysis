...
$step_width = 100; // Divide evenly across steps
...
<div id="revx-progress-inpage"
	...
	class="revx-campaign-fsb-<?php echo esc_attr( $position ); ?> revx-campaign-fsb revx-campaign-<?php echo esc_attr( $campaign['id'] ); ?>  <?php echo esc_attr( $cart_total <= 0 ? 'hide' : '' ); ?>"
	data-final-message="<?php echo esc_attr( $reward_message ); ?>"
	data-show-confetti="<?php echo esc_attr( $campaign['show_confetti'] ); ?>"
	data-based-on="<?php echo esc_attr( $based_on ); ?>"

	> 

	<div class="revx-campaign-fsb__container">
		<!-- Expanded Content -->
		<div>
