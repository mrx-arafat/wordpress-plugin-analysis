...
$generated_styles = revenue()->campaign_style_generator( 'bottom', $campaign );
...
<div data-campaign-id="<?php echo esc_attr( $campaign['id'] ); ?>" id="revx-countdown-bottom" style="display: none; width: 100%;" class="rvex-countdown-timer-wrapper rvex-countdown-wrapper rvex-banner-top-container rvex-banner-countdown">
	<div class="revx-countdown-timer-hellobar-wrapper" style=" <?php echo esc_attr( $container_style ); ?> max-width:100%; width:100%; position: relative;">
<?php
