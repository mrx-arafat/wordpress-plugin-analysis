...
$view_mode = 'list';
if ( 'list' === $view_mode ) {
	$buider_data = revenue()->get_campaign_meta( $campaign['id'], 'builderdata', true )['popup']['list'];
} else {
	$buider_data = revenue()->get_campaign_meta( $campaign['id'], 'builderdata', true )['popup']['grid'];
}
